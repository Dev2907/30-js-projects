class Database{
    ...
    constructor(dbname,ver,obj_stores, callback){
        ...
        this.loadDB(dbname,ver,obj_stores).then((result)=>{
            this.db = result;
            console.log(this.db);
            callback();
        }).catch((err)=>{
    ...
    */ 
    ...
    async getDB(storename,query) {
        return new Promise((resolve, reject) => {
                ...
                req.onsuccess = async (event) => {
                    resolve(event.target.result);
                    console.log(`Queried DB : ${this.dbname}, Store : ${storename}, for Query : ${query} `);
                };
                req.onerror = (event) => {
                    console.log(`DB Error: ${event.target.errorCode}`);
                    reject(null);
    ...
    async addDB(storename,data){
        return new Promise((resolve, reject) => {
                ...
                req.onsuccess = async (event) => {
                    resolve(event.target.result);
                    console.log(`Added Data : ${data} to DB : ${this.dbname}, Store : ${storename}`);
                };
                req.onerror = (event) => {
                    console.log(`DB Error: ${event.target.errorCode}`);
                    reject(null);
    ...
    async deleteDB(storename,query){
        return new Promise((resolve, reject) => {
                ...
                req.onsuccess = async (event) => {
                    resolve(event.target.result);
                    console.log(`Deleted id : ${query} from DB : ${this.dbname}, Store : ${storename}`);
                };
                req.onerror = (event) => {
                    console.log(`DB Error: ${event.target.errorCode}`);
                    reject(null);
    ...
    async countDB(storename) {
        return new Promise((resolve, reject) => {
                ...
                req.onsuccess = async (event) => {
                    resolve(event.target.result);
                    console.log(`Counted DB : ${this.dbname}, Store : ${storename}`);
                };
                req.onerror = (event) => {
                    console.log(`DB Error: ${event.target.errorCode}`);
                    reject(null);
